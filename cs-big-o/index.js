...
// ANSWER:O(n) n is the amount of time in nanoseconds. One operation with a set of numbers.

// Q: What is the space complexity?
// ANSWER: O(1) In short means that it takes a constant time no matter the amount of data in the set.
...
// ANSWER:No. It is a for loop that is O(n) that is only passed through 4 times or at length.
...
// Q: What is the time complexity of this function?
// ANSWER: O(n^2) one function with two nested for loops

// Q: What is the space complexity of this function?
// ANSWER: O(1) loops over the array twice.
...
// ANSWER: O(n) filters array and returns numbers less than five
...
// ANSWER: O(n) makes a copy of the array and multiplies each number by 3 return a new set of numbers
...
// ANSWER: O(n) runs through the array and removes the values 3 and 1
...
// Q: What is the time complexity of the function?
// ANSWER: O(n) runs through the array and add the values of 3, 0, and 19
...
// Q: What is the time complexity of the function?
// ANSWER: O(1) runs through the array and adds to the length inserting the value of 25
...
// Q: What is the time complexity of the function? 
// ANSWER: O(1) runs through and prints the value of first two names in the array starting at 0
...
function arrInception(parentArr) {
  ...
  // Q: What is the space complexity of this function?
  // ANSWER: O(1) It is an array of object arrays just the parent and the children
...
// ANSWER: change let squaredValue = Math.sqrt(numbers)    numbers array put in to run along each value
...
// ANSWER: Each function is dependent on the length of the string.
